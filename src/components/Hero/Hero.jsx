...
const Hero = () => {
    return <section className="h-[80vh] xl:h-[850px]">
            ...
            <div className='h-full flex flex-col justify-center items-center xl:items-start z-20 pt-12'>
                ...
                <motion.div
                    ...
                    <div className='hidden xl:flex items-center xl:gap-x-0'>
                        <div>World</div>
                        <div className='relative w-2 h-2 mx-2 flex items-center justify-center'><Image fill src={'/assets/hero/dot.svg'} /></div>
                        <div>Tour</div>
                        <div className='relative w-2 h-2 mx-2 flex items-center justify-center'><Image fill src={'/assets/hero/dot.svg'} /></div>
                    </div>
                ...
                <motion.div
                    ...
                    whileInView={'show'}
                    viewport={{ once: false, amount: 0.7 }}>
                    <Button className="rounded-full bg-accent2 hover:bg-accent2/50 transition-all duration-300">
                        Obtener Tickets
                    </Button>
                </motion.div>
            </div>
